...
\usepackage{ltablex}
\keepXColumns % Indispensable pour garder le comportement de tabularx
\pagestyle{empty}
...
\begin{tabularx}{\linewidth}{|c|X|r|r|}
    ...
    \hline
    \endfirsthead % Uniquement pour le début du tableau sur la 1ère page
    ...
    \textbf{\textcolor[RGB]{255,87,51}{Prix Total}} \\
    \hline
    \endhead % Répète l'en-tête sur les pages suivantes
